...
const app = {
  ...
  // config: JSON.parse(localStorage.getItem(PlAYER_STORAGE_KEY)) || {},
    ...
    {
      name: "See You Again",
      singer: "Wiz Khalifa and Charlie Puth",
      path: "see you again.mp4",
      image: "see u again.jpg"
    },
    {
      name: "Steal My Girl",
      singer: "One Direction",
      path: "steal my girl.mp4",
      image:
        "steal my girl.jpg"
    },
    {
      name: "One Call Away",
      singer: "Charlie Puth",
      path: "one call away.mp4",
      image: "one call away.jpg"
    },
    {
      name: "Monsters",
      singer: "Katie Sky",
    ...
    {
      name: "Dusk Till Dawn",
      singer: "Sia and Zayn Malik",
      path: "dusk till dawn.mp4",
      image: "dusk till dawn.jpg"
    },
    {
      name: "High Hopes",
